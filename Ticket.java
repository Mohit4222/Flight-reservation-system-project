...
public abstract class Ticket {
  ...
  //defining function to check whether ticket is confirmed or canceled
    public String checkStatus() {
        return cancelled ? "Cancelled" : "Confirmed";
    }
  //function to check journey time of flight
  ...
  //setting getter and setter for class attributes
    public void cancel() {
        cancelled = true;
    }
